<nav class="grid grid-cols-4 md:grid-cols-8 gap-4 shadow-md sticky top-0 w-full bg-white h-[65px]">
    ...
    <div class="grid col-start-4 md:col-end-9 md:col-span-3 xl:col-end-9 xl:col-span-3 place-content-center">
        ...
        <ul class="hidden md:flex md:flex-row font-normal">
            <li class="flex items-center space-x-3 p-2"><a class="hover:text-green-500" href="/MendoAgro/index.php"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-home">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
